...
const Header = () => {
  ...
  return (
    <>
          ...
          <div className="mx-auto max-w-full">
            <div className="flex h-14 items-center justify-between px-4 sm:px-6 lg:px-8">
              <div className="flex items-center gap-8">
                <a
                  href="/"
                  className="group flex items-center gap-1 text-xl sm:text-2xl font-bold text-white"
                >
                  <img
                    src="/icon.png"
                    alt="LmScale Logo"
              ...
              <button
                ...
                className="inline-flex items-center justify-center rounded-full p-2 text-white transition-colors duration-200 hover:bg-white/10 lg:hidden"
      ...
      {/* Mobile menu overlay */}
      <div
        className={`fixed inset-0 z-40 bg-black/90 backdrop-blur-xl transition-all duration-300 lg:hidden ${
          ...
          <div className="px-4 py-6">
            <nav className="flex flex-col space-y-1">
              ...
              <a
                href="/login"
                onClick={() => setIsMenuOpen(false)}
                className="flex items-center rounded-lg px-4 py-3 text-sm font-medium text-white transition-colors duration-200 hover:bg-white/5 hover:text-white"
              >
                Login
              </a>
              <a
