  ...
  return (
    <div className="relative min-h-screen bg-black font-mono">
      <div className="absolute inset-0">
        <div
          className="absolute inset-0 bg-[linear-gradient(to_right,#ffffff15_1px,transparent_1px),linear-gradient(to_bottom,#ffffff15_1px,transparent_1px)] bg-[size:24px_24px] md:bg-[size:32px_32px]"
          style={{
      ...
      <div className="relative mx-auto max-w-7xl px-4 pt-20 md:pt-24">
        <div className="text-center">
          <div className="mb-6 md:mb-8 inline-flex items-center rounded-full border border-white/10 bg-white/5 px-4 py-1.5 md:px-6 md:py-2 text-xs md:text-sm text-white/80 backdrop-blur-sm transition-all hover:bg-white/10">
          ...
          <div className="mt-8 md:mt-12 mx-auto max-w-6xl p-4 md:p-8 relative">
            ...
            <div className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg%20width%3D%2720%27%20height%3D%2720%27%20viewBox%3D%270%200%2020%2020%27%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%3E%3Crect%20width%3D%27100%25%27%20height%3D%27100%25%27%20fill%3D%27none%27%20%2F%3E%3Ccircle%20cx%3D%271%27%20cy%3D%271%27%20r%3D%270.5%27%20fill%3D%27%23ffffff10%27%20%2F%3E%3C%2Fsvg%3E')] opacity-50 rounded-xl" />

            <div className="relative flex flex-col items-center justify-start h-full space-y-8">
              <p className="mx-auto max-w-2xl text-base md:text-lg leading-7 md:leading-8 text-white/90 px-4">
                Deploy and scale language models with zero infrastructure
                headaches. Simple, fast, and secure cloud deployment.
              </p>

              <div className="flex items-center justify-center gap-4 md:gap-6">
                <a className="group inline-flex items-center rounded-lg bg-white px-6 md:px-8 py-2.5 md:py-3 text-sm md:text-base font-medium text-black transition-all duration-300 hover:bg-white/90 hover:scale-105">
                  Get Started
                  <svg
            ...
            <div className="mt-8 rounded-lg bg-black/60 p-3 md:p-4 backdrop-blur-sm">
              ...
              <pre className="text-left text-xs md:text-sm text-white/70 overflow-x-auto scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent">
                <code>
