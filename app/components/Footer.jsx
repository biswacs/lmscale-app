            ...
            <div className="flex space-x-6">
              {navigation.social.map((item) => (
                <a
                  key={item.name}
                  href={item.href}
                  className="text-neutral-400 transition-colors duration-300 hover:text-sky-400"
                >
                ...
                <ul role="list" className="mt-4 space-y-3">
                  {navigation.product.map((item) => (
                    <li key={item.name}>
                      <a
                        href={item.href}
                        className="group relative text-sm text-neutral-400 transition-colors duration-300 hover:text-sky-400"
                      >
                        <span className="absolute -left-2 top-1/2 h-1 w-1 -translate-y-1/2 rounded-full bg-sky-400 opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
                        {item.name}
                      </a>
                    </li>
                  ))}
        ...
        <div className="mt-16 border-t border-white/10 pt-8">
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            ...
            <div className="flex gap-4">
              <a
                className="text-xs text-neutral-400 transition-colors duration-300 hover:text-sky-400"
                href="#"
              >
                Changelog
              </a>
