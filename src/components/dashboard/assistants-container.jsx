        ...
        {!showCreateForm ? (
            ...
            <div className="space-y-4">
              {filteredAssistants.map((assistant) => (
                <button
                  ...
                  className="w-full p-4 border border-neutral-200 hover:border-neutral-300 
              ...
              <button
                ...
                className="w-full p-4 border border-dashed border-neutral-200 
          ...
          <form onSubmit={handleCreateSubmit}>
            ...
            <div className="mt-6 flex items-center justify-end gap-3">
              ...
              <button
                type="submit"
                disabled={isCreating || inputError || !newAssistantName.trim()}
